    ...
    public class DatabaseService
    {
        ...
        public List<Headset> GetAllHeadsets()
        {
            ...
            using (NpgsqlConnection connection = new NpgsqlConnection(connectionString))
            {
                ...
                string sql = "SELECT id, Brand, Model, Color, FrequencyRange, Microphone, NoiseCancellation, ClosedOrOpen, ItemCondition, Price, ImageUrl, type, Description FROM Headsets order by id";
